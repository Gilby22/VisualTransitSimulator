...
public class RandomPassengerGeneratorTest {
  ...
  /**
   * Test passenger generation (false branch).
   */
  @Test
  public void testGeneratePassengersTestWithProbsAndStopsFalse() {
    ...
    RandomPassengerGenerator pasGen = new RandomPassengerGenerator(probs, stops);
    int passAdded = pasGen.generatePassengers();
    assertEquals(true, passAdded > 0);
  }

  /**
   * Test passenger generation false deterministic.
   */
  @Test
  public void testGeneratePassengersTestWithProbsFalseDeter() {
    PassengerFactory.DETERMINISTIC = false;
