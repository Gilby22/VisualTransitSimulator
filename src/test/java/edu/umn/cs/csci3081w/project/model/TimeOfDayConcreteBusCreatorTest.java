...
public class TimeOfDayConcreteBusCreatorTest {
  ...
  /**
   * Test set morning strategy.
   */
  @Test
  public void testMorningStrategy() {
    TimeOfDayConcreteBusCreator timeOfDayConcreteBusCreator =
        new TimeOfDayConcreteBusCreator();
  ...
  /**
   * Test set day strategy.
   */
  @Test
  public void testDayStrategy() {
    TimeOfDayConcreteBusCreator timeOfDayConcreteBusCreator =
        new TimeOfDayConcreteBusCreator();
  ...
  /**
   * Test set evening strategy.
   */
  @Test
  public void testEveningStrategy() {
    TimeOfDayConcreteBusCreator timeOfDayConcreteBusCreator =
        new TimeOfDayConcreteBusCreator();
  ...
  /**
   * Test set night strategy right on the hour.
   */
  @Test
  public void testEveningOrNightStrategy() {
    TimeOfDayConcreteBusCreator timeOfDayConcreteBusCreator =
        new TimeOfDayConcreteBusCreator();
    timeOfDayConcreteBusCreator.setStrategy(21);
    BusDeploymentStrategy busDeploymentStrategy =
        timeOfDayConcreteBusCreator.getStrategy();
    assertTrue(busDeploymentStrategy instanceof BusDeploymentStrategyNight);
  }
