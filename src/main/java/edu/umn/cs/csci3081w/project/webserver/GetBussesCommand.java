...
public class GetBussesCommand extends MyWebServerCommand {
  ...
  public void execute(MyWebServerSession session, JsonObject command,
    ...
    for (int i = 0; i < busses.size(); i++) {
      ...
      jsonColor.addProperty("red", busses.get(i).getRed());
      jsonColor.addProperty("green", busses.get(i).getGreen());
      jsonColor.addProperty("blue", busses.get(i).getBlue());
      jsonColor.addProperty("alpha", busses.get(i).getAlpha());
